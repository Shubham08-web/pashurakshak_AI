...
ICONS = {
    ...
    "psychology": """
    <svg viewBox="0 0 24 24">
    <path d="M9 4a4 4 0 0 0-4 4v1a3 3 0 0 0 0 6v1a4 4 0 0 0 4 4"/>
    <path d="M15 4a4 4 0 0 1 4 4v1a3 3 0 0 1 0 6v1a4 4 0 0 1-4 4"/>
    ...
    <svg viewBox="0 0 24 24">
    <path d="M3 3l18 18"/>
    <path d="M5 9a11 11 0 0 1 12.5-.7"/>
    <path d="M8.5 12.5a6 6 0 0 1 5.2-.2"/>
    <path d="M12 17h.01"/>
    </svg>
    """,
